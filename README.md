...
## Game Description >> You Have Found a catacomb that contains a treasue in it .Your Task is to extract that treasure and take it. Ofcourse its not an easy task . Solve the mystery and the tresure is yours. This is your objective , find it and take it to the starting point. There are two of it all over the map . Anything that can be grabbed is useful so use it wisely.
